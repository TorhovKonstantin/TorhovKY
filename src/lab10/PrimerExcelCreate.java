...
public class PrimerExcelCreate {
    public static void main(String[] args) throws IOException {
        // Create new book Excel
        XSSFWorkbook workbook = new XSSFWorkbook();

        // Create new page from book
        XSSFSheet sheet = workbook.createSheet("Товары");

        // Write data from cell(ячейка)
        ...
        dataRow2.createCell(1).setCellValue("Процессор: Intel Core i5, Оперативная память: 2GB и т.д.");
        dataRow2.createCell(2).setCellValue(25000.0);


        // Write Excel Book to File
